...
class DurationSettings:
    ...
    ai_voiceover_trim_video_to_tts: bool = True
    ai_voiceover_trim_tail_tolerance_seconds: float = 0.8
    ai_voiceover_render_trim_to_tts: bool = True
    ai_voiceover_drop_unmatched_clips: bool = True
